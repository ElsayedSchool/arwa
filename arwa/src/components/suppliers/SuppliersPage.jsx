...
export const SuppliersPage = ({ onBack, userRole = "admin" }) => {
  ...
  const [selectedSupplierForPrice, setSelectedSupplierForPrice] =
    useState(null);
  const [selectedSupplierForDueDate, setSelectedSupplierForDueDate] =
    useState(null);
  ...
  const handleEditDueDate = (supplier) => {
    setSelectedSupplierForDueDate(supplier);
    setShowEditDueDateModal(true);
  };

  const handleUpdateDueDate = (supplierId, dueDateData) => {
    setSuppliersData((prev) =>
      prev.map((supplier) =>
        supplier.id === supplierId
          ? {
    ...
    setSelectedSupplierForDueDate(null);
  };
