...
export const EditSupplierModal = ({ isOpen, onClose, onSave, supplier }) => {
  ...
  useEffect(() => {
    if (supplier) {
      setFormData({
        ...
        fishTypes: supplier.fishTypes && supplier.fishTypes.length > 0 
          ? supplier.fishTypes 
          : [{ type: "", pricePerKg: "" }],
  ...
  const handleSubmit = () => {
    if (validateForm()) {
      ...
      onSave(supplier.id, updatedSupplier);
      handleClose();
    }
  };
