...
import { Eye, Trash2, MoreVertical, Fish, Edit } from "lucide-react";
import type { InventoryDeliveryUi } from "../api/InventoryApi";

interface InventoryTableProps {
  data: InventoryDeliveryUi[];
  userRole: string;
  onViewDetails: (delivery: InventoryDeliveryUi) => void;
  onDelete: (delivery: InventoryDeliveryUi) => void;
  onUpdateRestAmounts?: (delivery: InventoryDeliveryUi) => void;
  onEdit?: (delivery: InventoryDeliveryUi) => void;
}
