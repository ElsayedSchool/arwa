...
export const ProfitsPage = ({ onBack }) => {
  const [dailyProfits] = useState([
    ...
    <div className="min-h-screen bg-gray-50" dir="rtl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">متابعة الأرباح والإيرادات اليومية</p>
        </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{totalProfit.toLocaleString()} ج.م</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{avgDailyProfit.toFixed(0)} ج.م</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-sm">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{dailyProfits.length}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {dailyProfits.map((day, index) => {
                const profitMargin = ((day.profit / day.revenue) * 100).toFixed(1);
                return (
